...
{
    public class Dungeon3 : PlayScreen
    {
        public string MapName { private set; get; } = "dungeon_3";
        ...
        public override void LoadContent()
        {
            ...
            tileMap = new TmxMap("Content/tiledmaps/chapter_3/dungeon_3.tmx");
            ...
            entityDatas = content.Load<List<EntityData>>("data/chapter_3/dun/entites");
            objectDatas = content.Load<List<ObjectData>>("data/chapter_3/dun/objects");
            ...
            // Show Map Name Sign
            HUDSystem.ShowMapNameSign(1, "Tallinn: Dungeon Zone");

            // Music BG
            var bgMusic = GameGlobals.AddCurrentMapMusic(GameGlobals.Music.ch_3_Boss, content);
