...
{
    public class Dungeon2 : PlayScreen
    {
        public string MapName { private set; get; } = "dungeon_2";
        ...
        public override void LoadContent()
        {
            ...
            tileMap = new TmxMap("Content/tiledmaps/chapter_2/dungeon_2.tmx");
            ...
            entityDatas = content.Load<List<EntityData>>("data/chapter_2/dun/entites");
            objectDatas = content.Load<List<ObjectData>>("data/chapter_2/dun/objects");
            ...
            // Show Map Name Sign
            HUDSystem.ShowMapNameSign(1, "Rothenburg: Dungeon Zone");

            // Music BG
            var bgMusic = GameGlobals.AddCurrentMapMusic(GameGlobals.Music.ch_2_Boss, content);
