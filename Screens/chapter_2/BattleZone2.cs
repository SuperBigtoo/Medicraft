...
{
    public class BattleZone2 : PlayScreen
    {
        public string MapName { private set; get; } = "battlezone_2";
        ...
        public override void LoadContent()
        {
            ...
            tileMap = new TmxMap("Content/tiledmaps/chapter_2/battlezone_2.tmx");
            ...
            entityDatas = content.Load<List<EntityData>>("data/chapter_2/battle/entites");
            objectDatas = content.Load<List<ObjectData>>("data/chapter_2/battle/objects");
            ...
            // Show Map Name Sign
            HUDSystem.ShowMapNameSign(1, "Rothenburg: Battle Zone");

            // Music BG
            var bgMusic = GameGlobals.AddCurrentMapMusic(GameGlobals.Music.ch_2_Mon, content);
