...
{
    public class Dungeon1 : PlayScreen
    {
        public string MapName { private set; get; } = "dungeon_1";
        ...
        public override void LoadContent()
        {
            ...
            var tileSets = new Texture2D[]  // The maximum number of TileSet is 5
            {
                ...
                content.Load<Texture2D>("tiledmaps/textures/TS1-2")
            };
            tileMap = new TmxMap("Content/tiledmaps/chapter_1/dungeon_1.tmx");
            ...
            entityDatas = content.Load<List<EntityData>>("data/chapter_1/dun/entites");
            objectDatas = content.Load<List<ObjectData>>("data/chapter_1/dun/objects");
            ...
            // Show Map Name Sign
            HUDSystem.ShowMapNameSign(1, "Nordlingen: Dungeon Zone");
